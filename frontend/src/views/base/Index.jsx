    ...
    <>
      ...
      <section class="showcase">
        ...
        <div class="text">
          ...
          <p className="para">
            Learn from the top Instructor over the World.
            <br />
            Learn the latest Technology Trend.
          </p>
        </div>
      </section>
          ...
          <div className="row mb-5">
            ...
            <div className="col-md-6 col-lg-3 border-top-md border-top border-end-lg">
              ...
              <div className="py-7 text-center">
                ...
                {/* text */}
                <div className="lh-1">
                  <h2 className="mb-1">1 Thousands+</h2>
            ...
            <div className="col-md-6 col-lg-3 border-top-lg border-top border-end-md">
              ...
              <div className="py-7 text-center">
                ...
                <div className="lh-1">
                  ...
                  <span>Courses in 2 languages</span>
                </div>
              </div>
            </div>
                  ...
                  <div className="col">
                    ...
                    <div className="card card-hover">
                      ...
                      <div className="card-body">
                        ...
                        <small>By: {c.teacher?.full_name || "Unknown"}</small>
                        <small>
        ...
        <div className="container">
          ...
          <div className="row align-items-center bg-primary gx-0 rounded-3 mt-5">
            ...
            style={{
              ...
              height: "auto",
              zIndex: 1,
              transform: "translate(20%, -20%)" // Tweak to keep inside
            }}
          />
                  </div> */}
                </div>
                        ...
                        <div className="card">
                          <div className="card-body text-center p-6">
                            ...
                            <p className="mb-0 mt-3">
                              “This LMS is a lifeline for busy pros. I loved the
                              flexible, high-quality content and offline access
                              for my commute. The Q&A was responsive, and the
                              'notes' feature kept me organized. A smooth
                              payment process was a huge plus. Just needs more
                              varied quiz formats.”
                            </p>
                            {/* rating */}
                      ...
                      <div className="item">
                        <div className="card">
                          <div className="card-body text-center p-6">
                            ...
                            />
                            <p className="mb-0 mt-3">
                              “As a student, this LMS was a great, affordable
                              intro to web development. Content is solid, but
                              video lengths were inconsistent, making pacing
                              tough. The community was quiet, so quick answers
                              were hard to find. Had a quick payment issue, but
                              support fixed it. Good for the price, but less
                              interactive.”
                            </p>
                            {/* rating */}
                            <div className="lh-1 mb-3 mt-4">
                            ...
                            <h3 className="mb-0 h4">Sandeep</h3>
                            <span>Software Engineer </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="item">
                        <div className="card">
                          <div className="card-body text-center p-6">
                            ...
                            />
                            <p className="mb-0 mt-3">
                              “Promising platform, and the 'Data Science' course
                              was comprehensive across levels. Instructor engagement was low, and
                              customization for 'notifications' could be better.
                              Fair price with a nice coupon option. Solid, but
                              could be outstanding with some tweaks."
                            </p>
                            {/* rating */}
                            <div className="lh-1 mb-3 mt-4">
                              <span className="fs-6 align-top">
                            ...
                            <h3 className="mb-0 h4">Ashish</h3>
